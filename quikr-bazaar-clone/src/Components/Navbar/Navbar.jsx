        ...
        <div className={Styles.content}>
          <ul className={Styles.links}>
            ...
            <li>
              {/* mobiles-tab */}
              <div>
                <NavLink to='/mobiles' className={Styles.navLink_tabs}>MOBILES<AiOutlineDown/></NavLink>
              </div>
              <div className={Styles.subtabs}>
                ...
                <div className={Styles.tabs_row}>
                  <ul>
                    ...
                    <li>
                      <NavLink to="/lg-phones" className={Styles.sublink__link}>
                        LG Phones
                      </NavLink>
                    </li>
                  </ul>
                  <ul>
                    ...
                    <li className={Styles.sublink__list}>
                      <NavLink to="/4g-ready" className={Styles.sublink__link}>
                        4G Ready
                      </NavLink>
                    </li>
                    <li>
                    ...
                    <li>
                      <NavLink to="/high-ram" className={Styles.sublink__link}>
                        High RAM
                      </NavLink>
                    </li>
                  </ul>
                ...
                <div className={Styles.tabs_row}>
                  <ul>
                    ...
                    <li>
                      <NavLink to="/earphones" className={Styles.sublink__link}>
                        Earphones
                      </NavLink>
                    </li>
                    <li>
            ...
            <li>
              {/* FURNITURE-TAB */}
              <div>
                <NavLink to='/furniture-decor' className={Styles.navLink_tabs}>
                  FURNITURE & DECOR
                  <AiOutlineDown/>
                </NavLink>
              </div>
              <div className={Styles.subtabs}>
                ...
                <div className={Styles.tabs_row}>
                  <ul>
                    ...
                    <li>
                      <NavLink to="/recliners" className={Styles.sublink__link}>
                        Recliners
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/Shoe-racks" className={Styles.sublink__link}>
                        Shoe Racks
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/center-tables" className={Styles.sublink__link}>
                        Center Tables
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/bean-bags" className={Styles.sublink__link}>
                        Bean Bags
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/folding-chairs" className={Styles.sublink__link}>
                        Folding Chairs
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/plastic-chairs" className={Styles.sublink__link}>
                        Plastic Chairs
                      </NavLink>
                    </li>
                    <li>
            ...
            <li>
              <div>
                <NavLink to='/electronic' className={Styles.navLink_tabs}>ELECTRONICS<AiOutlineDown/></NavLink>
              </div>
              <div className={Styles.subtabs}>
                {/* televisions */}
                <div className={Styles.tabs_row}>
                ...
                <div className={Styles.tabs_row}>
                  <ul>
                    ...
                    <li className={Styles.sublink__list}>
                      <NavLink to="/desktops" className={Styles.sublink__link}>
                        Desktops
                      </NavLink>
                    </li>
                    <li className={Styles.sublink__list}>
                  ...
                  <ul>
                    ...
                    <li className={Styles.sublink__list}>                      
                      <NavLink to="/sony-ps4" className={Styles.sublink__link}>
                        Sony PS4
                      </NavLink>
                    </li>
                    <li>
                    ...
                    <li>
                      <NavLink to="/sony-playstation" className={Styles.sublink__link}>
                        Sony Playstation
                      </NavLink>
                    </li>
                  </ul>
                ...
                <div className={Styles.tabs_row}>
                  <ul>
                    ...
                    <li className={Styles.sublink__list}>
                      <NavLink to="/dvd-blu-ray-players" className={Styles.sublink__link}>
                        DVD Blu-Ray Players
                      </NavLink>
                    </li>
                    <li className={Styles.sublink__list}>
                  ...
                  <ul>
                    ...
                    <li className={Styles.sublink__list}>
                      <NavLink to="/external-hard-drives" className={Styles.sublink__link}>
                        External Hard Drives
                      </NavLink>
                    </li>
                    <li className={Styles.sublink__list}>
                      <NavLink to="/pen-drives" className={Styles.sublink__link}>
                        Pen Drives
                      </NavLink>
                    </li>
                  </ul>
            ...
            <li >
              <div>
                <NavLink to='/home-appliances'  className={Styles.navLink_tabs}>
                  Home Appliances<AiOutlineDown/>
                </NavLink>
              </div>
              <div className={Styles.subtabs}>
                {/* Refrigeratios */}
            ...
            <li>
              <div>
                <NavLink to='/kids-toys' className={Styles.navLink_tabs}>KIDS & TOYS<AiOutlineDown/></NavLink>
              </div>
              <div className={Styles.subtabs}>
                {/* Refrigeratios */}
                <div className={Styles.tabs_row}>
            ...
            <li>
              <div>
                <NavLink to='/sports-hobbies-fashion' className={Styles.navLink_tabs}>SPORTS,HOBBIES & FASHION<AiOutlineDown/></NavLink>
              </div>
              <div className={Styles.subtabs}>
                {/* Refrigeratios */}
                <div className={Styles.tabs_row}>
